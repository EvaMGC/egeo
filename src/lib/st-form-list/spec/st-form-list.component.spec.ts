...
//          imports: [FormsModule, StInputModule, PipesModule, StFormDirectiveModule],
...
//    });
//
//    fdescribe('should be able to create an array of items', () => {
//       beforeEach(() => {
...
//             expect(controls[i].name).toBe(Object.keys(TWO_INPUTS_JSON_SCHEMA.properties)[i] + '-' + 0);
//          }
//       });
//
...
//             expect(inputs[0].name).toBe(itemProperties[0] + '-' + i);
...
//
//             expect(inputs[1].name).toBe(itemProperties[1] + '-' + i);
